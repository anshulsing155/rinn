...
<footer
  ...
  <div class="mx-10 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
        <h6
          class="mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
          ...
          <span class="text-green-800 font-bold text-lg">Rinn</span>
        </h6>
        <p class="mb-8">
            Rinn is a family of companies serving all your homeownership needs.
        </p>
        <h6
          class=" mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; Mortgage
        </h6>
        <p class="mb-8">
        ...
        <h6
          class=" mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; real estate
        </h6>
        <p class="mb-8">
        ...
        <h6
          class=" mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; cover
        </h6>
        <p class="mb-8">
        ...
        <h6
          class="  mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; inspect
        </h6>
        <p class="mb-8">
        ...
        <h6
          class=" mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; settlement services
        </h6>
        <p class="mb-8">
        ...
        <h6
          class="  mb-3 flex items-center justify-center font-semibold uppercase md:justify-start">
          <span class="text-green-800 font-bold text-lg">Rinn</span>&nbsp; Attorney Match
        </h6>
        <p class="mb-8">
      ...
      <div class="ml-14">
        <h6
          class="mb-6 flex justify-center font-semibold uppercase md:justify-start">
          Services
        </h6>
        <p class="mb-6">
          <a href="#!" class="text-neutral-600 dark:text-neutral-200"
      ...
      <div class="ml-10">
        ...
        <p class="mb-6 flex items-center justify-center md:justify-start">
          ...
          G-248, Sector 63, Noida, Uttar Pradesh, 201307
        </p>
        <p class="mb-6 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="mb-10 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
